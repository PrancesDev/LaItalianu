...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    super.initState();
    // Check if a location is already selected, otherwise navigate to selection screen
  ...
  void didChangeDependencies() {
    ...
    // Ensure the selected location is still valid
  ...
  void didUpdateWidget(HomeScreen oldWidget) {
    ...
    // Re-check location on widget updates
    final location = context.watch<LocationNotifier>().selectedLocation;
    if (location == null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.pushReplacement(
  ...
  void setState(VoidCallback fn) {
    // Override setState to ensure we always have a valid location when updating
    final location = context.read<LocationNotifier>().selectedLocation;
    if (location == null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        Navigator.pushReplacement(
